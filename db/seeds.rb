...
Band.create(name: 'Wet Sprocket', manager_id: 1)
Band.create(name: 'Squish', manager_id: 2)
Band.create(name: 'Uncle Trisket', manager_id: 2)
Band.create(name: 'Big Skies', manager_id: 3)
Band.create(name: 'Young Swiss', manager_id: 3)
Band.create(name: 'The Holy Mackerels', manager_id: 3)
Band.create(name: 'Snowboy', manager_id: 3)
Band.create(name: 'Surfaris', manager_id: 2)
